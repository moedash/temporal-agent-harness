...
class OpenAIAgentsPlugin(SimplePlugin):
    ...
    Example:
        ...
        >>> from temporal_agent_harness.ai_sdks.openai_agents import OpenAIAgentsPlugin, ModelActivityParameters, StatelessMCPServerProvider
    ...
    def tracing_context(self) -> Iterator[None]:
        ...
        .. code-block:: python
            ...
            with env.openai_agents.tracing_context():
